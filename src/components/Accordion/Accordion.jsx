...
function Accordion() {
    const rules = [
        ...
        },
        {
            ...
            description: `Only one of the dealer's cards is revealed to start, however the dealer will immediately let you know if they have <strong>Blackjack</strong> and you will simply lose
...
// </p>
    ...
    return (
        ...
        <div className="accordion">
            {rules.map((rule, i) => ( 
            <>
                <button className='infoButton' onClick={() => handleToggle(i)}>{rule.title}</button><br/>
                {open === i ?
